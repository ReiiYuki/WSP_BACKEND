...
class OrderSerializer(serializers.ModelSerializer) :
    class Meta :
        model = Order
        fields = ('id','method','address','create_date','pay_date','transfer_slip','is_paid','is_shipped','user','is_active')
        extra_kwargs = {'id':{'read_only':True},'is_active':{'read_only':True},'create_date':{'read_only':True},'pay_date':{'read_only':True},'transfer_slip':{'read_only':True},'is_paid':{'read_only':True},'is_shipped':{'read_only':True},'user':{'read_only':True}}
